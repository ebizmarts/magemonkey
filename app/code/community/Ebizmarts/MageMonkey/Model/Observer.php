...
class Ebizmarts_MageMonkey_Model_Observer
{
    ...
    public function updateCustomer(Varien_Event_Observer $observer)
    {
        ...
        $isCheckout = $request->getControllerName() == 'sales_order_create' || $request->getModuleName() == 'checkout' || $request->getModuleName() == 'sgps' || Mage::getSingleton('core/session')->getIsOneStepCheckout() || Mage::getSingleton('core/session')->getMonkeyCheckout();
//        $isConfirmNeed = FALSE;
